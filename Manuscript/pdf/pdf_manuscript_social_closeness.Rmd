...
```{r fig2, fig.cap='Frecuencies of paying and Promise choice'}
...
```{r fig3, fig.cap='Rates by partners and promise condition', fig.height=10, fig.width=5}
...
```{r fig4, fig.cap='Estimates with uncertainty and linear predictor'}
...
```{r fig5, fig.cap='Estimates with uncertainty by subject'}
...
```{r fig6, fig.cap='Posterior predictive distribution of choices by partner'}
...
```{r fig7, fig.cap='Posteriors from two latent groups and two cases'}
...
```{r fig8, fig.cap='Payment frecuency by latent group and promise condition', fig.height=10, fig.width=5}
...
```{r fig9, fig.cap='Differences in reaction time by latent group'}
