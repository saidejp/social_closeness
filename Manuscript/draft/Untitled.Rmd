---
title: "Modelamiento Bayesiano de la (Des)honestidad: el Efecto de la Cercanía Social"
...
Desde la infidelidad afectiva hasta los fraudes financieros, la deshonestidad es ubicua en la interacciones humanas. Para el estudio de este fenómeno, se han utilizado frecuentemente: cuestionarios de autorreporte [@Halevy2014], encuestas [@Serota2010] o narraciones autobiográficas sobre mentiras que los participantes hayan dicho (o bien, de las que hayan sido victimas) [@DePaulo2004]. Sin embargo, existe la preocupación de que los resultados derivados de estos estudios incluyan sesgos por deseabilidad social, o que tengan poco poder predictivo [@Baumgartner2013]. Para contrarrestar dichas críticas, múltiples estudios han abordado la deshonestidad en el laboratorio, en donde ésta puede surgir de manera genuina y generar consecuencias específicas para el participante o para otros [@Gneezy2005; @Gneezy2013; @Fischbacher2013a].


Un ejemplo de los experimentos sobre deshonestidad son los estudios en los que los participantes realizan promesas sobre su comportamiento (e.g. si inviertes tu dinero en mí te retribuiré después); y posteriormente tienen la posibilidad de cumplir o romper sus promesas [@Vanberg2008; @Baumgartner2013; @Baumgartner2009; @Charness2006]. En general, se sabe que las personas tienen preferencia por mantener sus promesas _per se_, en este sentido son honestas. Sin embargo, nosotros creemos que el efecto de las promesas puede variar en función de la cercanía percibida hacia la persona a la que se le promete algo, por ejemplo, la cantidad de dinero a la que una persona está dispuesta a renunciar para compartirla con otra, decrece de forma hiperbólica dependiendo de la distancia social percibida [@Rachlin2006; @Vekaria2017]. Asimismo, se sabe que la experiencia subjetiva de compartir tiene mayor valor cuando se trata de alguien cercano que alguien lejano (e.g. un amigo vs. un desconocido) [@Fareri2012]. Así, es posible pensar que a mayor cercanía social habrá un mayor efecto de las promesas -la gente será más honesta-, y aumentará la deshonestidad conforme la cercanía social disminuya.  


El presente trabajo evalúa los efectos de la cercanía social en la deshonestidad, utilizando métodos de inferencia Bayesiana y modelamiento cognitivo [@Lee2014; @Lee2018]. A la fecha, los estudios que evalúan el efecto de las promesas en la cooperación o la deshonestidad se han basado en modelos que promedian los resultados entre todos los sujetos experimentales, lo que ignora la posibilidad de diferencias individuales entre la conducta de los sujetos [@Lee2005]. Para modelar las diferencias individuales, al mismo tiempo que estimamos parámetros poblacionales, usamos un Modelo Bayesiano Jerárquico que estima dichas diferencias explícitamente y asume que provienen de una distribución poblacional común [@Gelman2006; @Burkner2017]. 

Por otra parte, en dos de los estudios que utilizan tareas experimentales con promesas [@Baumgartner2013; @Baumgartner2009], se ha realizado la clasificación de los individuos de acuerdo con su comportamiento durante la tarea, aquellos sujetos que tienen altas tasas de pago se han denominado _Honestos_, mientras que aquellos que tienen bajas tasas les han llamado _Deshonestos_. Nuestro estudio, propone modelar las diferencias en las tasas de pago por medio de un modelo de mezclas latentes, que asume que la conducta de nuestros sujetos durante el experimento podría provenir de dos procesos cognitivos no observables: _honestidad_ y _deshonestidad_. El modelamiento de mezclas latentes asume que cada individuo es honesto o no lo es, y que el mismo individuo utiliza el mismo proceso cognitivo durante toda la tarea, lo que permite distribuir a los sujetos en conjuntos con diferentes comportamientos [@Lee2018]. 

Finalmente, algunos estudios han encontrado diferencias en los tiempos de reacción entre _honestos_ y _deshonestos_ [@Ben-Shakhar2017], con los subgrupos detectados por medio del modelo de mezclas latentes, modelamos los tiempos de reacción de las subpoblaciones y evaluamos por medio del factor de Bayes la evidencia en favor del hallazgo descrito en la literatura. 
