...
En dos de los estudios que utilizan tareas experimentales con promesas [@Baumgartner2013; @Baumgartner2009], se ha realizado la clasificación de los individuos de acuerdo con su comportamiento durante la tarea, aquellos sujetos que tienen altas tasas de pago se han denominado _Deshonestos_, mientras que aquellos que tienen bajas tasas les han llamado _Honestos_. Nuestro estudio, propone modelar las diferencias en las tasas de pago por medio de un modelo de mezclas latentes, lo que asume que la conducta de nuestros sujetos durante el experimento podría provenir de dos procesos cognitivos no observables: _honestidad_ y _deshonestidad_. El modelamiento de mezclas latentes asume que cada individuo es honesto o no lo es, y que el mismo individuo utiliza el mismo proceso cognitivo durante toda la tarea, lo que permite distribuir a los individuos en conjuntos con diferentes comportamientos [@Lee2018]. 
